...
def test_mm_embedding_return_with_qwen3vl():
    """
    Test that multimodal embeddings are returned when enabled.

    This test uses Qwen3-VL as an example multimodal model.
    """
...
if __name__ == "__main__":
    ...
    print("To run them, remove the @pytest.mark.skip decorators and ensure"
          " you have:")
    print("  1. A GPU available")
    print(f"  2. The {MODEL} model downloaded")
